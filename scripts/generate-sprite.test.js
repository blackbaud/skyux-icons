...
describe('generate-sprites', () => {
  ...
  it('should add the branded CSS class to icons in the branded folder', async () => {
    ...
    expect(fs.writeFile).toHaveBeenCalledWith(
      ...
      '<svg id="sky-icon-svg-sprite" hidden="true"><defs><svg viewBox="0 0 100 100" id="sky-i-fluent-1-24-solid" xmlns="http://www.w3.org/2000/svg"><path d="e" fill="#242424"/></svg><svg viewBox="0 0 100 100" id="sky-i-fluent-1-25-line" xmlns="http://www.w3.org/2000/svg"><path d="e" fill="#242424"/></svg><svg viewBox="0 0 100 100" id="sky-i-fluent-2-24-line" xmlns="http://www.w3.org/2000/svg"><path d="e" fill="#242424"/></svg><svg viewBox="0 0 100 100" id="sky-i-fluent-2-24-solid" xmlns="http://www.w3.org/2000/svg"><path d="e" fill="#242424"/></svg><svg class="sky-i-branded" viewBox="0 0 100 100" id="sky-i-test-branded" xmlns="http://www.w3.org/2000/svg"><path d="b" fill="#242424"/><path d="c" fill="#fff"/><path d="d" fill="#000"/></svg><svg viewBox="0 0 100 100" id="sky-i-test-unbranded" xmlns="http://www.w3.org/2000/svg"><path d="a" fill="#242424"/></svg></defs></svg>',
      { encoding: 'utf-8' },
    );
  });
